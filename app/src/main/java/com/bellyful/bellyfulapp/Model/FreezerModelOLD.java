...
class FreezerModelOLD extends DatabaseHelper {
    ...
    public FreezerModelOLD() {
        super("Freezer");
    }

    public FreezerModelOLD(String name, String address, String phone, String mealName, String mealQty) {
        this.name = name;
